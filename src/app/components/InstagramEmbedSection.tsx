      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-lg lg:text-xl text-white/80 max-w-2xl mx-auto">
            Fortis Yapım'ın günlük çalışma hayatından, set arkası anlardan ve projelerimizden kareler.
          </p>
        </motion.div>
        ...
        >
          <div className="bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-sm rounded-2xl p-8 lg:p-12 border border-white/10">
            ...
            <p className="text-white/80 text-lg mb-6 max-w-2xl mx-auto">
              Fortis Yapım'ın günlük çalışma hayatından, set arkası anlardan ve projelerimizden daha fazla kare için Instagram hesabımızı takip edin.
            </p>
            <a
